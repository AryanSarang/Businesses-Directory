...
const Profile = () => {
    ...
    return (
        <div className="profile w-full md:p-11 rounded-lg flex gap-x-10 text-center">

                <form onSubmit={handleSubmit} >
                        <div className="block md:flex gap-x-12 gap-y-5 overflow-auto">
                            <div className="block md:flex flex-col gap-y-5">
                            ...
                            <div className="block md:flex md:flex-col lg:flex-row gap-x-10 gap-y-5">
                            ...
                            <div className='flex flex-col gap-y-5'>
                                <div className="text-left mb-5">
                                    ...
                                    <div className='flex items-center justify-between mb-2 w-full bg-white rounded py-1 px-2'>
                                        <input 
                                            type={
                                ...
                                <div className="text-left mb-5">
                                    <div className='font-semibold mb-2'>Confirm Password </div>
                                    <div className='flex items-center justify-between mb-2 w-full bg-white rounded py-1 px-2'>
                                        <input
                                            type={
                                                showPassword ? "text" : "password"
                        ...
                        <button disabled={loading} type="submit" className="mt-10 ml-auto text-white save-button self-start border-solid border-2 rounded-md bg-slate-700 px-2 py-1">
